...
@section('main')
            ...
            <center>
                ...
                <table class="tcenter" id="maintable">
                    <thead>
                        ...
                        <th style="width: 10%">Sem/Year</th>
                        <th style="width: auto">Title</th>
                        <th style="width: 10%">type</th>
                        <th style="width: 10%">UploadAt</th>
                        <th style="width: 5%">About</th>
                        <th style="width: 5%">Report</th>
                        <!-- <th>3</th> -->
                    </thead>
                    <tbody>
                        @foreach ($asses as $ass)
                            <tr onclick="window.location='{{ url($ass->link) }}';" style="cursor:pointer;">
                                <td>{{ $i++ }}</td>
                                <td>{{ $ass->year }}</td>
                                <td>{{ $ass->title }}</td>
                                <td>{{ $ass->type }}</td>
                                <td>{{ $ass->created_at->format('d/m/y') }}</td>
                                <td><button onclick="event.stopPropagation();"
                                        class="btn btn-primary rounded-pill show-modal" data-id={{ $ass->ucode }}
                                        data-toggle="modal" data-target="#modal-lg"><i class="fa fa-book"
                                            aria-hidden="true"></i></button></td>
                                <td class="text-center"><button data-id={{ $ass->ucode }}
                                        class="btn btn-danger rounded-pill"><i class="fa fa-exclamation-circle"
                                            style="color: white" aria-hidden="true"></i></button></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="dec-body">
    ...
    <div class="modal fade" id="modal-report">
        <div class="modal-dialog modal-report">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Report Assignmnet!!</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.show-modal').on('click', function() {
                    $('#dec-body').empty();
                    $('#dec-body').append('<p>Please Wait Loading..!</p>');
